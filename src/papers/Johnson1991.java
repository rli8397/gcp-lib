...
public class Johnson1991{
        ...
        public void Johnson1991FixedK() {
            ...
            while (freezecount < freeze_lim) {
                ...
                while (trials < sizefactor * ncap && change < cutoff * ncap){
                    ...
                    //Calculate Delta
                    double delta = calcNeighborObjective(target, newColor) - objective;
                ...
                //If enough changes per trial is too low, it's freezing. Changes have to be happening
    ...
    /* 
        //FixedK method calls for switching a random node with conflicting edges to a new color
